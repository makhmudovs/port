<section class="bg-gray-200 text-gray-600 body-font relative dark:bg-gray-800" id="contact">
	<div class="container px-6 py-16 mx-auto">
		<div class="flex flex-col text-center w-full mb-12">
			<h1 class="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900 dark:text-gray-200">Contact Me</h1>
			<p class="lg:w-2/3 mx-auto leading-relaxed text-base dark:text-gray-200">
				Please contact me for offers and collaborations.
			</p>
		</div>
		<div class="lg:w-1/2 md:w-2/3 mx-auto">
			<div class="flex flex-wrap -m-2">
				...
				<div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
					<a href="#" class="text-orange-500 dark:text-gray-200">example@email.com</a>
					<p class="leading-normal my-5 dark:text-gray-200">
						49 Smith St.
